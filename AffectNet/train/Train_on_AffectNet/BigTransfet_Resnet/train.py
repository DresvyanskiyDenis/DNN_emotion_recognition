...
from AffectNet.train.Train_on_AffectNet.BigTransfet_Resnet.utils import load_normalize_image
...
for i in range(validation_labels.shape[0]):
    validation_data[i]=load_normalize_image(path_to_validation_images+validation_labels.index[i])
